...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "pony-mode" '("pony")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "pony-tpl" '("pony-" "sgml-indent-line-num")))
